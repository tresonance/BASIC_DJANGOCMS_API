...
While ``myblog`` does not ship any comment system, this flag
...
BLOG_CURRENT_POST_IDENTIFIER = "myblog_post_current"
"""
.. _CURRENT_POST_IDENTIFIER:
Current post identifier in request.
Name of the request attribute used in :py:class:`cms_myblog.cms_toolbars.BlogToolbar` to detect if
request match a post detail.
"""

BLOG_CURRENT_NAMESPACE = "myblog_post_current_config"
"""
.. _CURRENT_NAMESPACE:
Current post config identifier in request.
Name of the request attribute used in :py:class:`cms_mybblog.cms_toolbars.BlogToolbar` to detect the
...
Show cms_myblog-blog toolbar in any page, even when outside the blog apphooks.
"""

BLOG_PLUGIN_MODULE_NAME = _("Blog")
"""
.. _PLUGIN_MODULE_NAME:
Name of the cms_myblog-blog plugins module (group).
"""
