...
from utils.fields import slugify
from utils.managers import GenericDateTaggedManager
...
class Post(KnockerModel, BlogMetaMixin, TranslatableModel):
    ...
    author = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="myblog_post_author",
    ...
    categories = models.ManyToManyField(
        "myblog.BlogCategory", verbose_name=_("category"), related_name="blog_posts", blank=True
    )
...
class LatestPostsPlugin(BasePostPlugin):
    ...
    tags = TaggableManager(
        ...
        related_name="myblog_latest_post",
    )
    categories = models.ManyToManyField(
        "myblog.BlogCategory",
        blank=True,
